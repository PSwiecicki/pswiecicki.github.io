    ...
    <Wrapper>
      ...
      <div>
        ...
        <p>
          ...
          Science. During these studies, I wrote applications in Java, operated
          on databases using SQL queries, completed the CCNA1 course, created
          simple pages using PHP and completed the 'AWS Academy Cloud
          Foundations' course.
        </p>
        <p>
